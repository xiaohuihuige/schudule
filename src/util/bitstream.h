...
static int bs_read_string(bs_t *bs, int str_size, char *string, int size);
...
static inline int bs_read_string(bs_t *bs, int str_size, char *string, int size)
{
...
static inline uint32_t bs_read_ru(bs_t* b, int n)//读取n个字节,不移动
{
    uint32_t r = 0;
    int i;
